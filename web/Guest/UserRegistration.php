...
if(isset($_POST["btn_save"]))
{
	...
	move_uploaded_file($temp, "../Assets/Files/".$photo);
	
	$insqry="insert into tbl_user (user_name,user_password,place_id,user_address,user_email,user_contact,user_photo) values('".$name."','".$password."','".$place."','".$address."','".$email."','".$contact."','".$photo."')";
        ...
        <div id="tab" align="center">
            <table border="0">
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="txt_address2" id="txt_address" required cols="30" rows="10"></textarea>
                    </td>
                </tr>
                <tr>
                    <th>
